...
constexpr std::array<std::string_view, 6> CEG_TERM_LIBRARY_FUNC_PATTERNS =
{
    "A1 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 83 C4 ?? 51 FF 15 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 ?? 50 FF 15 ?? ?? ?? ?? B0 01 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C3",
    "E8 ?? ?? ?? ?? 83 EC ?? 8B CC C7 01 ?? ?? ?? ?? 89 41 ?? C7 01 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 ?? 50 FF ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 ?? 50 FF 15 ?? ?? ?? ?? B0 01 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C3",
